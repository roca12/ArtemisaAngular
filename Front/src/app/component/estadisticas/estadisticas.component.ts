...
export class EstadisticasComponent implements OnInit, AfterViewInit {
  ...
  calculateStatsUVA(): void {
    ...
    this.uvastats.push(
      parseFloat(precision.toString()).toFixed(2).toString() + "%",
    );
  }
  ...
  getCFAll(username: string): void {
    this.http
      .get(this.getCFUrl + username, { observe: "response" })
  ...
  getSPOJAll(username: string): void {
    this.http
      .get(this.getSPOJUrl + username, { observe: "response" })
      .subscribe((response: any) => {
  ...
  getCodeChefAll(): void {
    this.http
      .get(this.getCodechefUrl + this.usernamecc, { observe: "response" })
      .subscribe((response: any) => {
  ...
  getUvaAllInfo(uid: string): void {
    this.http
      .get(this.getAllUrl + uid, { observe: "response" })
      .subscribe((response: any) => {
  ...
  getUvaIdCode(username: string): void {
    this.http
      .get(this.getuidUrl + username, { observe: "response" })
      .subscribe((response: any) => {
